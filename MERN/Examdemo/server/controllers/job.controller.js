...
module.exports.oneJob = (req, res) =>{
    Job.findOne({_id: req.params.id})         // << database id is called _id. id in curly bracket should match id in route. ex: app.get('/api/jobs/:id', JobController.oneJob) //show one
